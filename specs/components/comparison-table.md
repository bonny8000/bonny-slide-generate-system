...
**Highlighted column** may be either a **raised tint** (`--accent-soft` fill + accent border) or an
**inverted quiet/dark surface** with light text and `--accent` stats (Img16) — both read as "this is the
focus." Use one or the other, never two highlighted columns.
