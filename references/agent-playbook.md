...
- Start from `assets/templates/slide-template.html`.
- Link `assets/bonny-slide-v2-tokens.css`.
- Use semantic classes from the token file.
- Use `lang="zh-TW"` for CJK text blocks and `lang="en"` or `.latin` for English/numbers.
